...
**Вопрос:** "Алекс, кто такой Эклер и как вы связаны?"

**Правильный ответ должен включать:**
- ✅ Эклер — это Алекса, помощница для Натальи
...
- `instructions/ALEX_ECLAIR_SYNC.md` — Протокол связи с Эклером
